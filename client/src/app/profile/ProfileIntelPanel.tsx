  ...
  return (
    <Box style={{ background: '#0d0d0d', border: '1px solid #1a1a1a', borderRadius: '4px', padding: '12px' }}>
      <Group gap={6} align="baseline" mb={10}>
        <Text style={{ fontSize: '15px', fontWeight: 600, color: '#d4d4d4', letterSpacing: '0.04em' }}>Favorites</Text>
        <Text style={{ fontSize: '11px', color: '#333', letterSpacing: '0.15em', textTransform: 'uppercase' }}>· intel</Text>
      </Group>

      {/* Characters — delegated to CharacterFavoritesManager */}
      <Text style={{ fontSize: '12px', color: '#666', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '6px' }}>Characters</Text>
      <Box mb={12}>
        <CharacterFavoritesManager />
      </Box>

      {/* Quote */}
      <Text style={{ fontSize: '12px', color: '#666', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '6px' }}>Quote</Text>
      {loading ? (
        ...
        >
          <Text style={{ fontSize: '15px', color: '#ccc', fontStyle: 'italic', lineHeight: 1.6, fontFamily: 'var(--font-opti-goudy-text)' }}>
          ...
          {selectedQuote.character?.name && (
            <Text style={{ fontSize: '13px', color: '#777', marginTop: '4px' }}>
      ...
      {/* Gamble */}
      <Text style={{ fontSize: '12px', color: '#666', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '6px' }}>Gamble</Text>
      <Box
      ...
      >
        ...
        <Text style={{ fontSize: '15px', color: selectedGamble ? '#ccc' : '#666', flex: 1 }}>
          {selectedGamble ? selectedGamble.name : 'Select a favorite gamble'}
        </Text>
        {gambleRange && (
          <Text style={{ fontSize: '13px', color: '#666' }}>{gambleRange}</Text>
        )}
      </Box>
    </Box>
  )
