              ...
              <Stack gap="md">
                <Select
                  ...
                  onChange={(value) => {
                    ...
                    handleInputChange('ownerId', null) // Reset owner when type changes
                  }}
                  data={OWNER_TYPE_OPTIONS}
                  required
                  clearable
                  description="Choose the type of entity you want to annotate"
                  styles={{
                    input: {
                ...
                {formData.ownerType && (
                  <Select
                    ...
                    clearable
                    searchable
                    description={`The ${formData.ownerType} you want to annotate`}
                    styles={{
                      input: {
                        backgroundColor: theme.colors.dark?.[5] ?? '#0b0b0b',
                        color: theme.colors.gray?.[0] ?? '#fff',
                ...
                <TextInput
                  ...
                  description="Choose a clear, descriptive title for this annotation (minimum 3 characters)"
                  styles={{
                    input: {
                      backgroundColor: theme.colors.dark?.[5] ?? '#0b0b0b',
                      color: theme.colors.gray?.[0] ?? '#fff',
                ...
                <Textarea
                  ...
                  description={`Write your annotation in detail (${formData.content.length}/10+ characters)`}
                  styles={{
                    input: {
                      backgroundColor: theme.colors.dark?.[5] ?? '#0b0b0b',
                      color: theme.colors.gray?.[0] ?? '#fff',
                ...
                <NumberInput
                  label="Chapter Reference (Optional)"
