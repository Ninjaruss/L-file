...
const gambles = [
  {
    ...
    rules:
      'A survival game where participants must escape a dangerous abandoned building while facing various traps and psychological challenges.',
    winCondition:
      'Successfully escape the building while outmaneuvering opponents.',
    chapterId: 6,
  },
  {
    name: 'Poker Shark',
    ...
    rules:
      'Standard Seven-card Stud poker with Kakerou stakes. Players must read opponents and manage their chips strategically.',
    winCondition:
      'Win the poker game by having the best hand or forcing opponents to fold.',
    chapterId: 24,
  },
  {
    name: 'Hangman Game',
    ...
    rules:
      'A twisted version of Hangman where wrong guesses have severe consequences. Players must deduce the hidden word while managing risk.',
    winCondition:
      'Guess the word/phrase correctly before running out of chances.',
    chapterId: 41,
  },
  {
    ...
    rules:
      'Navigate a complex situation starting with absolutely nothing. Players must use wit and strategy to acquire resources.',
  ...
  },
  {
    ...
    rules:
      'Navigate through a complex maze with various challenges and opponents lurking within.',
    winCondition:
      'Reach the exit of the labyrinth while overcoming all obstacles.',
    chapterId: 104,
  },
  {
    ...
    rules:
      'A psychological and physical endurance game involving extreme heat and pressure.',
  ...
  },
  {
    ...
    rules:
      'Ascend through the tower while completing challenges at each level. Each floor presents unique dangers and puzzles.',
  ...
  },
  {
    ...
    rules:
      'A deadly version of the classic Battleship game with real stakes and consequences.',
  ...
  },
  {
    ...
    rules:
      'A complex game involving the 卍 (manji) pattern with strategic and psychological elements.',
  ...
  },
  {
    name: 'Protoporos',
    description:
      'The main game on Protoporos Island containing multiple sub-games.',
    rules:
      'A comprehensive tournament system on Protoporos Island involving various games and faction conflicts.',
  ...
  },
  {
    ...
    rules:
      'A unique poker variant where cards are played "in the air" using memory and psychological deception. Players must remember all cards played.',
    winCondition:
      'Win the poker game using air-based betting mechanics and superior memory.',
    chapterId: 429,
  },
  {
    ...
    rules:
      'Players must collect the required number of handkerchiefs through various means.',
  ...
  },
  {
    ...
    rules:
      'A deadly adaptation of the children\'s game "Drop the Handkerchief" with life-or-death stakes.',
