...
--
-- Name: event_status_enum; Type: TYPE; Schema: public; Owner: ninjaruss
--
...
ALTER TYPE public.event_status_enum OWNER TO ninjaruss;
...
--
-- Name: media_ownertype_enum; Type: TYPE; Schema: public; Owner: ninjaruss
--

CREATE TYPE public.media_ownertype_enum AS ENUM (
    'character',
    'arc',
    'event',
    'gamble',
...
ALTER TYPE public.media_ownertype_enum OWNER TO ninjaruss;

--
-- Name: media_purpose_enum; Type: TYPE; Schema: public; Owner: ninjaruss
--

CREATE TYPE public.media_purpose_enum AS ENUM (
    'gallery',
    'entity_display'
);


ALTER TYPE public.media_purpose_enum OWNER TO ninjaruss;
...
--
-- Name: page_view_pagetype_enum; Type: TYPE; Schema: public; Owner: ninjaruss
--

CREATE TYPE public.page_view_pagetype_enum AS ENUM (
    'guide',
    'character',
    'event',
    'gamble',
...
ALTER TYPE public.page_view_pagetype_enum OWNER TO ninjaruss;
...
CREATE TABLE public.event (
    ...
    type public.event_type_enum DEFAULT 'decision'::public.event_type_enum NOT NULL,
    "chapterNumber" integer NOT NULL,
    "spoilerChapter" integer,
    status public.event_status_enum DEFAULT 'draft'::public.event_status_enum NOT NULL,
    "arcId" integer,
    "gambleId" integer,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL,
...
--
-- Name: gamble_participants; Type: TABLE; Schema: public; Owner: ninjaruss
--
...
ALTER TABLE public.gamble_participants OWNER TO ninjaruss;
...
--
-- Name: guide_characters; Type: TABLE; Schema: public; Owner: ninjaruss
--

CREATE TABLE public.guide_characters (
    "guideId" integer NOT NULL,
    "characterId" integer NOT NULL
);


ALTER TABLE public.guide_characters OWNER TO ninjaruss;

--
-- Name: guide_gambles; Type: TABLE; Schema: public; Owner: ninjaruss
--

CREATE TABLE public.guide_gambles (
    "guideId" integer NOT NULL,
    "gambleId" integer NOT NULL
);


ALTER TABLE public.guide_gambles OWNER TO ninjaruss;
...
CREATE TABLE public.media (
    ...
    "ownerType" public.media_ownertype_enum,
    "ownerId" integer,
    ...
    purpose public.media_purpose_enum DEFAULT 'gallery'::public.media_purpose_enum NOT NULL
);
...
--
-- Name: page_view; Type: TABLE; Schema: public; Owner: ninjaruss
--

CREATE TABLE public.page_view (
    id integer NOT NULL,
    "pageType" public.page_view_pagetype_enum NOT NULL,
...
ALTER TABLE public.page_view OWNER TO ninjaruss;

--
-- Name: page_view_id_seq; Type: SEQUENCE; Schema: public; Owner: ninjaruss
--
...
ALTER TABLE public.page_view_id_seq OWNER TO ninjaruss;

--
-- Name: page_view_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ninjaruss
--
...
--
-- Name: page_view id; Type: DEFAULT; Schema: public; Owner: ninjaruss
--
...
COPY public.arc (id, name, "order", description, "startChapter", "endChapter", "imageFileName", "imageDisplayName") FROM stdin;
1	Introduction Arc	0	Introduction to the world of underground gambling and Baku Madarame's unique abilities. This arc establishes the foundation of the story, introducing key characters, the concept of lie detection, and the dangerous nature of high-stakes gambling.	1	10	\N	\N
2	Kakerou Initiation Arc	1	Baku's formal introduction to the Kakerou organization and its complex hierarchy. He learns about the rules, consequences, and opportunities within this underground gambling syndicate.	11	25	\N	\N
...
COPY public."character" (id, name, "alternateNames", description, "firstAppearanceChapter", "imageFileName", "imageDisplayName") FROM stdin;
1	Baku Madarame	The Lie Eater,Mad Dog	The main protagonist, known for his ability to see through deception and his exceptional gambling skills. Baku has an uncanny ability to detect lies and uses this to his advantage in high-stakes gambling scenarios.	1	\N	\N
2	Marco Reiji	The Young Gun	A skilled gambler who becomes one of Baku's closest allies. Marco is known for his strategic thinking and unwavering loyalty to his friends.	5	\N	\N
3	Kyara Kujaku	The Broker	A cunning information broker who plays multiple sides. Known for his manipulative nature and extensive network of contacts in the underground world.	8	\N	\N
4	Sadakuni Ikki	Leader	The leader of Kakerou, a mysterious and powerful figure who oversees the organization's operations and maintains order in the underground gambling world.	12	\N	\N
5	Hal Arimura	The Calculator	A mathematical genius who excels at games requiring complex calculations and probability analysis. Often serves as an advisor in strategic situations.	15	\N	\N
6	Mako Obara	The Analyst	A careful observer and analyst who supports Baku's team with detailed analysis of opponents and situations.	20	\N	\N
7	Yakou Hikoichi	Night Owl	A night-dwelling gambler with expertise in underground networks and nocturnal gambling events.	25	\N	\N
8	Fukurou Tsukiyo	The Owl	A mysterious figure known for appearing at crucial moments with valuable information or assistance.	30	\N	\N
\.
...
COPY public.event (id, title, description, type, "chapterNumber", "spoilerChapter", status, "arcId", "gambleId", "createdAt", "updatedAt", "createdById") FROM stdin;
4	Strategic Alliance Formation	Key characters form an alliance that will shape the future power dynamics in the gambling world.	shift	15	15	approved	6	1	2025-09-10 21:12:36.177181	2025-09-11 07:33:03.62388	\N
3	First Major Gamble	Baku participates in his first high-stakes gamble, establishing his reputation in the underground gambling world.	gamble	10	10	approved	6	1	2025-09-10 21:12:36.175934	2025-09-11 07:33:17.650669	\N
5	Tournament Resolution	The conclusion of a major tournament arc with lasting consequences for all participants.	resolution	25	25	approved	6	1	2025-09-10 21:12:36.178415	2025-09-11 07:33:27.411208	\N
2	Meeting Marco	Baku encounters Marco Reiji, who becomes one of his closest allies in the gambling world.	reveal	5	5	approved	6	1	2025-09-10 21:12:36.174484	2025-09-11 07:33:44.101546	\N
1	Baku's Introduction	The first appearance of Baku Madarame, showing his uncanny ability to detect lies and his gambling prowess.	reveal	1	1	approved	4	1	2025-09-10 21:12:36.171656	2025-09-11 07:35:55.975069	\N
\.
...
COPY public.gamble (id, name, rules, "winCondition", "chapterId", "createdAt", "updatedAt") FROM stdin;
1	Protoporos	A game involving removing stones from piles. Players take turns removing any number of stones from a single pile. The objective varies depending on the specific variant being played.	The player who is forced to take the last stone loses the game.	1	2025-09-10 21:12:36.210917	2025-09-10 21:12:36.210917
2	Poker Tournament	Standard Texas Hold'em poker with high stakes. Each player receives two hole cards and must make the best five-card hand using any combination of their hole cards and the community cards.	The player with the best hand at showdown wins the pot. The tournament continues until one player has all the chips.	5	2025-09-10 21:12:36.211975	2025-09-10 21:12:36.211975
3	Russian Roulette Variant	A deadly variant of Russian Roulette using a special mechanism. Players take turns with specific rules that determine the outcome based on psychological and strategic elements.	Survive all rounds while maintaining psychological advantage over opponents.	10	2025-09-10 21:12:36.214555	2025-09-10 21:12:36.214555
4	Card Matching Game	A complex card game involving memory, strategy, and psychological manipulation. Players must match cards while predicting opponent moves.	First player to achieve the target score or eliminate all opponents wins.	15	2025-09-10 21:12:36.215782	2025-09-10 21:12:36.215782
\.


--
-- Data for Name: gamble_participants; Type: TABLE DATA; Schema: public; Owner: ninjaruss
--

COPY public.gamble_participants ("gambleId", "characterId") FROM stdin;
1	1
1	2
\.
...
--
-- Data for Name: guide_gambles; Type: TABLE DATA; Schema: public; Owner: ninjaruss
--

COPY public.guide_gambles ("guideId", "gambleId") FROM stdin;
1	1
\.
...
1	5	1	2025-09-10 21:12:36.24289
2	4	1	2025-09-10 21:12:36.244844
3	3	1	2025-09-10 21:12:36.246064
4	5	2	2025-09-10 21:12:36.25088
5	4	2	2025-09-10 21:12:36.251576
6	4	3	2025-09-10 21:12:36.256312
7	2	3	2025-09-10 21:12:36.257243
8	1	3	2025-09-10 21:12:36.259156
9	1	4	2025-09-10 21:12:36.263437
10	2	4	2025-09-10 21:12:36.264396
11	3	4	2025-09-10 21:12:36.265188
12	5	4	2025-09-10 21:12:36.266164
\.
...
COPY public.media (id, url, "fileName", "b2FileId", "isUploaded", "ownerType", "ownerId", "chapterNumber", "isDefault", type, description, status, "rejectionReason", "createdAt", "submittedById", purpose) FROM stdin;
1	https://www.youtube.com/watch?v=dQw4w9WgXcQ	\N	\N	f	\N	\N	\N	f	video	Fan-made AMV showcasing Baku's most intense gambling moments	approved	\N	2025-09-10 21:12:36.21943	3	gallery
2	https://www.deviantart.com/example/art/baku-madarame-fanart-123456789	\N	\N	f	\N	\N	\N	f	image	Digital artwork of Baku Madarame in his iconic pose	approved	\N	2025-09-10 21:12:36.222189	3	gallery
3	https://www.pixiv.net/en/artworks/123456789	\N	\N	f	\N	\N	\N	f	image	Character illustration of Marco during the card tournament	approved	\N	2025-09-10 21:12:36.223778	3	gallery
4	https://twitter.com/example/status/123456789	\N	\N	f	\N	\N	\N	f	image	Sketch of Baku and Marco working together	pending	\N	2025-09-10 21:12:36.225558	3	gallery
6	https://www.youtube.com/watch?v=example123	\N	\N	f	\N	\N	\N	f	video	Analysis video discussing Usogui gambling strategies	approved	\N	2025-09-10 21:12:36.227831	3	gallery
5	https://www.instagram.com/p/example123/	\N	\N	f	character	\N	\N	f	image	Cosplay photo of Baku Madarame costume	pending	\N	2025-09-10 21:12:36.226815	3	gallery
7	https://www.youtube.com/watch?v=HCc3Ol7adcw	\N	\N	f	character	1	1	t	video	its my video lol	approved	\N	2025-09-10 21:32:00.5798	6	gallery
8	https://www.youtube.com/shorts/UdTfZY2m2Ao	\N	\N	f	character	1	1	t	image	yes	approved	\N	2025-09-11 08:10:24.143706	6	gallery
\.


--
-- Data for Name: page_view; Type: TABLE DATA; Schema: public; Owner: ninjaruss
--

COPY public.page_view (id, "pageType", "pageId", "ipAddress", "userAgent", "createdAt") FROM stdin;
1	event	1	::ffff:127.0.0.1	Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:142.0) Gecko/20100101 Firefox/142.0	2025-09-11 07:10:43.254498
2	event	2	::ffff:127.0.0.1	Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:142.0) Gecko/20100101 Firefox/142.0	2025-09-11 07:10:48.243936
3	gamble	4	::ffff:127.0.0.1	Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:142.0) Gecko/20100101 Firefox/142.0	2025-09-11 07:36:14.648044
4	character	8	::ffff:127.0.0.1	Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:142.0) Gecko/20100101 Firefox/142.0	2025-09-11 07:49:02.898175
\.
...
1	The essence of gambling is not about winning or losing... it's about the thrill of the unknown.	1	Baku's philosophy on gambling introduced early in the story	15	1	2025-09-10 21:12:36.18672	2025-09-10 21:12:36.18672	1
2	A lie isn't necessarily a bad thing. Sometimes it's the kindest truth you can offer.	3	Baku explaining his perspective on deception	22	1	2025-09-10 21:12:36.190768	2025-09-10 21:12:36.190768	1
3	In the world of gambling, trust is the most dangerous bet you can make.	5	Marco's cynical view on trust in gambling	8	2	2025-09-10 21:12:36.193232	2025-09-10 21:12:36.193232	1
4	I don't gamble to win money. I gamble to understand people.	7	Baku revealing his deeper motivation for gambling	34	1	2025-09-10 21:12:36.194456	2025-09-10 21:12:36.194456	1
5	The moment you think you've figured out the game is the moment you've already lost.	12	Baku's warning about overconfidence	19	1	2025-09-10 21:12:36.196163	2025-09-10 21:12:36.196163	1
6	Every gambler has a tell. The trick is knowing when they're telling the truth.	15	Marco discussing the psychology of gambling	41	2	2025-09-10 21:12:36.19797	2025-09-10 21:12:36.19797	1
7	Fear and excitement... they're closer than most people realize.	20	Baku on the emotional aspects of high-stakes gambling	27	1	2025-09-10 21:12:36.199135	2025-09-10 21:12:36.199135	1
8	The house always wins? That's what they want you to believe.	25	Marco challenging conventional gambling wisdom	12	2	2025-09-10 21:12:36.200335	2025-09-10 21:12:36.200335	1
9	Sometimes the best move is the one that makes no sense to anyone else.	30	Baku's unpredictable strategic approach	35	1	2025-09-10 21:12:36.201983	2025-09-10 21:12:36.201983	1
10	In gambling, as in life, the only certainty is uncertainty.	35	Philosophical reflection during a tense gambling match	45	1	2025-09-10 21:12:36.204122	2025-09-10 21:12:36.204122	1
11	You can't bluff someone who has nothing left to lose.	40	Marco observing desperate opponents	18	2	2025-09-10 21:12:36.206919	2025-09-10 21:12:36.206919	1
12	The real game isn't about the cards you're dealt, but how you play them.	45	Baku's perspective on strategy over luck	28	1	2025-09-10 21:12:36.209375	2025-09-10 21:12:36.209375	1
\.
...
COPY public."user" (id, username, email, "discordId", "discordUsername", "discordAvatar", "isEmailVerified", "emailVerificationToken", password, "passwordResetToken", "passwordResetExpires", role, "userProgress", "profileImageId", "favoriteQuoteId", "favoriteGambleId", "createdAt", "updatedAt", "refreshToken") FROM stdin;
1	admin	admin@usogui-fansite.com	\N	\N	\N	t	\N	$2b$10$0d3ca1OiH9tKnZ5A40uuruVZCPIg54u906C5nw.MixyjMctitL562	\N	\N	admin	50	\N	\N	\N	2025-09-10 21:12:35.772773	2025-09-10 21:12:35.772773	\N
2	moderator	moderator@usogui-fansite.com	\N	\N	\N	t	\N	$2b$10$1OAO5C30nfHRGmlLoGT3oe4Tg2ltlrY/sfE6dfPU6arJnCoZRHYES	\N	\N	moderator	30	\N	\N	\N	2025-09-10 21:12:35.858487	2025-09-10 21:12:35.858487	\N
3	testuser	test@example.com	\N	\N	\N	t	\N	$2b$10$0HplYCGfytICykInHDsnkuv/jr.e/E8BYlnSoocnIkEBxVRt7Ed.2	\N	\N	user	15	\N	\N	\N	2025-09-10 21:12:35.966457	2025-09-10 21:12:35.966457	\N
4	avid_reader	reader@example.com	\N	\N	\N	t	\N	$2b$10$qXoPlRk2BM9GBlU/E3PvOuurOdNS.DASiFipse.dtlsP2Qk2xQyay	\N	\N	user	42	\N	\N	\N	2025-09-10 21:12:36.043512	2025-09-10 21:12:36.043512	\N
5	manga_newbie	newbie@example.com	\N	\N	\N	t	\N	$2b$10$XYY47YCKNbnSkXRQJEx8jubtWDGTdVFTnYC8vNpKfV/PSDq8SxJF.	\N	\N	user	5	\N	\N	\N	2025-09-10 21:12:36.101952	2025-09-10 21:12:36.101952	\N
6	ninjaruss	russ081999@gmail.com	190911312933552128	ninjaruss	https://cdn.discordapp.com/avatars/190911312933552128/4b20adc0362aaf1d35829f97b2be7e7a.png	t	\N	\N	\N	\N	admin	10	\N	\N	\N	2025-09-10 21:13:13.100017	2025-09-10 21:13:13.80714	c4d635d3df02efe36b64df9cf0a964f0baf93b232026fbeec7574b8523e7250f6ee4ed507385f4ffc16a844163342cc2
\.
...
1	1	\N	1	10	Introduction to Baku Madarame and the underground gambling world	2025-09-10 21:12:36.117339	2025-09-10 21:12:36.117339
2	2	\N	11	20	Baku faces his first serious challenge in the gambling underworld	2025-09-10 21:12:36.118652	2025-09-10 21:12:36.118652
\.
...
SELECT pg_catalog.setval('public.guide_like_id_seq', 12, true);
...
--
-- Name: page_view_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ninjaruss
--

SELECT pg_catalog.setval('public.page_view_id_seq', 4, true);
...
--
-- Name: guide_characters PK_2e8130d5a53853fc9ec702acb65; Type: CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.guide_characters
    ADD CONSTRAINT "PK_2e8130d5a53853fc9ec702acb65" PRIMARY KEY ("guideId", "characterId");
...
--
-- Name: gamble_participants PK_383ec92ff6ed4966ba2f6778887; Type: CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.gamble_participants
    ADD CONSTRAINT "PK_383ec92ff6ed4966ba2f6778887" PRIMARY KEY ("gambleId", "characterId");


--
-- Name: guide_gambles PK_3878831afc5077bcb149b09aa1c; Type: CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.guide_gambles
    ADD CONSTRAINT "PK_3878831afc5077bcb149b09aa1c" PRIMARY KEY ("guideId", "gambleId");
...
--
-- Name: page_view PK_b01ec2dc6dc377f811d4db5613e; Type: CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.page_view
    ADD CONSTRAINT "PK_b01ec2dc6dc377f811d4db5613e" PRIMARY KEY (id);
...
--
-- Name: user UQ_13af5754f14d8d255fd9b3ee5c7; Type: CONSTRAINT; Schema: public; Owner: ninjaruss
--
...
--
-- Name: IDX_09d333fa0459381de49a6e5f86; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_09d333fa0459381de49a6e5f86" ON public.page_view USING btree ("createdAt");
...
--
-- Name: IDX_109ff4d030d2f5affde8b503d2; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_109ff4d030d2f5affde8b503d2" ON public.event USING btree ("chapterNumber");
...
--
-- Name: IDX_13af5754f14d8d255fd9b3ee5c; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_13af5754f14d8d255fd9b3ee5c" ON public."user" USING btree ("discordId");
...
--
-- Name: IDX_1d7059788a50a43fab4781a037; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_1d7059788a50a43fab4781a037" ON public.media USING btree ("ownerType", "ownerId");


--
-- Name: IDX_2076c89149da3c49f51118767c; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_2076c89149da3c49f51118767c" ON public.gamble_participants USING btree ("characterId");
...
--
-- Name: IDX_313a85bf816d5950603d466285; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_313a85bf816d5950603d466285" ON public.media USING btree ("ownerType", "ownerId", "chapterNumber");


--
-- Name: IDX_3284ce0261c1737683d0007fcd; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_3284ce0261c1737683d0007fcd" ON public.gamble_participants USING btree ("gambleId");
...
--
-- Name: IDX_39ecd5ac59a78603abbfb6532b; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_39ecd5ac59a78603abbfb6532b" ON public.media USING btree (purpose);
...
--
-- Name: IDX_55c434bd87f170609abd8a8d8b; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_55c434bd87f170609abd8a8d8b" ON public.page_view USING btree ("pageType", "pageId");
...
--
-- Name: IDX_5c40269c201e69a45a3618cf8d; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_5c40269c201e69a45a3618cf8d" ON public.guide_gambles USING btree ("guideId");
...
--
-- Name: IDX_788ddad1db9ca51bf892fec4bd; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_788ddad1db9ca51bf892fec4bd" ON public.page_view USING btree ("pageType", "createdAt");
...
--
-- Name: IDX_be1fe41c4ce23ec11871cac404; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_be1fe41c4ce23ec11871cac404" ON public.media USING btree ("ownerType", "ownerId", "isDefault");
...
--
-- Name: IDX_c01f607837e9d9986c777c9433; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_c01f607837e9d9986c777c9433" ON public.guide_gambles USING btree ("gambleId");
...
--
-- Name: IDX_e0539c3e84dc5e148c8f7a127c; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_e0539c3e84dc5e148c8f7a127c" ON public.guide_characters USING btree ("characterId");
...
--
-- Name: IDX_eb119f98f81c90aa9c0ccbe1d7; Type: INDEX; Schema: public; Owner: ninjaruss
--

CREATE INDEX "IDX_eb119f98f81c90aa9c0ccbe1d7" ON public.guide_characters USING btree ("guideId");
...
--
-- Name: gamble_participants FK_2076c89149da3c49f51118767cc; Type: FK CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.gamble_participants
    ADD CONSTRAINT "FK_2076c89149da3c49f51118767cc" FOREIGN KEY ("characterId") REFERENCES public."character"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: gamble_participants FK_3284ce0261c1737683d0007fcdb; Type: FK CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.gamble_participants
    ADD CONSTRAINT "FK_3284ce0261c1737683d0007fcdb" FOREIGN KEY ("gambleId") REFERENCES public.gamble(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: guide_gambles FK_5c40269c201e69a45a3618cf8d3; Type: FK CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.guide_gambles
    ADD CONSTRAINT "FK_5c40269c201e69a45a3618cf8d3" FOREIGN KEY ("guideId") REFERENCES public.guide(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: guide_gambles FK_c01f607837e9d9986c777c94336; Type: FK CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.guide_gambles
    ADD CONSTRAINT "FK_c01f607837e9d9986c777c94336" FOREIGN KEY ("gambleId") REFERENCES public.gamble(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: guide FK_c6926558969f3469b86f9828b36; Type: FK CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.guide
    ADD CONSTRAINT "FK_c6926558969f3469b86f9828b36" FOREIGN KEY ("arcId") REFERENCES public.arc(id);
...
--
-- Name: guide_characters FK_e0539c3e84dc5e148c8f7a127ca; Type: FK CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.guide_characters
    ADD CONSTRAINT "FK_e0539c3e84dc5e148c8f7a127ca" FOREIGN KEY ("characterId") REFERENCES public."character"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: guide_characters FK_eb119f98f81c90aa9c0ccbe1d72; Type: FK CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.guide_characters
    ADD CONSTRAINT "FK_eb119f98f81c90aa9c0ccbe1d72" FOREIGN KEY ("guideId") REFERENCES public.guide(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: event FK_f7e9bcade82098f32bbd360edae; Type: FK CONSTRAINT; Schema: public; Owner: ninjaruss
--

ALTER TABLE ONLY public.event
    ADD CONSTRAINT "FK_f7e9bcade82098f32bbd360edae" FOREIGN KEY ("gambleId") REFERENCES public.gamble(id);
